...
\node[derived attribute] (pl4) [above right of=podder] {Число начертаний} edge (podder);
\node[derived attribute] (pl5) [below right of=podder] {Число языков} edge (podder);
...
\node[text width=20em, anchor=north west, font=\small] (goals) at ([xshift=-15em, yshift=0]current bounding box.north east) {
    ...
    \begin{enumerate}
        ...
        \item Начертание поддерживает символ.
