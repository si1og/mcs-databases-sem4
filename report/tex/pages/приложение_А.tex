\section*{Приложение А. Исходный код SQL-скрипта для создания таблиц базы данных}
\phantomsection
\label{app:init-sql}
\addcontentsline{toc}{section}{Приложение А. Исходный код SQL-скрипта для создания таблиц базы данных}
