...
\begin{table}[H]
    ...
    \begin{tblr}{
        ...
        \hline
        1 & \mintinline{text}{Seq Scan} & \\
        2 & \mintinline{text}{Index Only Scan} & \\
        3 & \mintinline{text}{Index Only Scan} & \\
        4 & \mintinline{text}{Index Scan } & \\
        5 & \mintinline{text}{Index Scan} & \\
        6 & \mintinline{text}{Index Scan} & \\
