...
Для каждого формата посчитать число начертаний и число символов алфавита. Полученные пары значений используются для построения двумерной гистограммы.
...
\screenshot[0.75]{histograms/query-03-histogram.png}{Двумерная гистограмма по результатам запроса 3}

\subsubsection{Запрос 4}

Посчитать число начертаний с одинаковым числом символов. Полученные пары значений используются для построения двумерной гистограммы.
...
\screenshot[0.8]{histograms/query-04-histogram.png}{Двумерная гистограмма по результатам запроса 4}
...
Для каждой категории и каждого языка посчитать число символов. Для вывода используются первые 10 языков; результат предназначен для построения двумерной гистограммы.
...
\screenshot[0.9]{histograms/query-08-histogram.png}{Двумерная гистограмма по результатам запроса 8}
