...
\img[0.9]{img/quaries.pdf}{Лист проверки выполнения запросов}{\label{fig:query-check-list}}
...
\img[0.95]{img/query-01-plan.png}{План выполнения запроса 1}{\label{fig:query-01-plan}}
...
\img[0.65]{img/query-01-result.png}{Результат выполнения запроса 1}{\label{fig:query-01-result}}
...
\img[0.95]{img/query-02-plan.png}{План выполнения запроса 2}{\label{fig:query-02-plan}}
...
\img[0.55]{img/query-02-result.png}{Результат выполнения запроса 2}{\label{fig:query-02-result}}
...
\img[0.75]{img/query-04-plan.png}{План выполнения запроса 4}{\label{fig:query-04-plan}}
...
\img[0.75]{img/query-05-plan.png}{План выполнения запроса 5}{\label{fig:query-05-plan}}
...
\img[0.75]{img/query-05-result.png}{Результат выполнения запроса 5}{\label{fig:query-05-result}}
...
\img[0.75]{img/query-06-plan.png}{План выполнения запроса 6}{\label{fig:query-06-plan}}
...
\img[0.6]{img/query-06-result.png}{Результат выполнения запроса 6}{\label{fig:query-06-result}}
...
\img[0.95]{img/query-07-plan.png}{План выполнения запроса 7}{\label{fig:query-07-plan}}
...
\img[0.6]{img/query-07-result.png}{Результат выполнения запроса 7}{\label{fig:query-07-result}}
...
\img[0.75]{img/query-08-plan.png}{План выполнения запроса 8}{\label{fig:query-08-plan}}
...
\img[0.95]{img/query-09-plan.png}{План выполнения запроса 9}{\label{fig:query-09-plan}}
...
\img[0.75]{img/query-09-result.png}{Результат выполнения запроса 9}{\label{fig:query-09-result}}
