...
Для создания таблиц базы данных был написан SQL-скрипт для СУБД PostgreSQL (приложение А). В проекте используется база данных \mintinline{text}{typography}, запущенная в контейнере Docker. Контейнер базы данных создаётся на основе образа PostgreSQL и доступен на локальном порту \mintinline{text}{5432}.
...
Количество записей в каждой таблице приведено на схеме базы данных (рис. 5).
