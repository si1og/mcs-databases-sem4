...
\fullPageFigure{tex/graphics/db-schema.pdf}{Схема базы данных на русском языке}{\label{fig:db-schema-ru}}
\fullPageFigure{tex/graphics/db-schema-eng.pdf}{Схема базы данных на английском языке}{\label{fig:db-schema-eng}}

\subsection{Схема заполнения уровней прогруммируемой базы данных}

Схема заполнения уровней программируемой базы данных (рисунки~\ref{fig:db-schema-small-ru} и~\ref{fig:db-schema-small-eng}) приведена на рисунке \ref{fig:db-level-schema}.

\input{tex/graphics/level-schema.tex}
...
\fullPageFigure{tex/graphics/db-schema-small.pdf}{Программируемая схема базы данных на русском языке}{\label{fig:db-schema-small-ru}}
\fullPageFigure{tex/graphics/db-schema-small-eng.pdf}{Программируемая схема базы данных на английском языке}{\label{fig:db-schema-small-eng}}
